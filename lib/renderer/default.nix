...
let
  funcs = lib.fix (self: {
    renderInterface = import ./renderInterface.nix { inherit lib; inherit self; };
    renderSwitchport = import ./renderSwitchport.nix { inherit lib; inherit self; };
    ...
    mkTitle = device: title:
      lib.optionalString device.comments ''
        ...
        ! +----------------------------+
      '';
    renderACLs = import ./renderACLs.nix { inherit lib; inherit self; };
    renderGlobalIPv6Settings = import ./renderGlobalIPv6Settings.nix { inherit lib; inherit self; };
    renderGlobalIPSettings = import ./renderGlobalIPSettings.nix { inherit lib; inherit self; };
    renderRoute = import ./renderRoute.nix { inherit lib; inherit self; };
    renderEEM = import ./renderEEM.nix { inherit lib; inherit self; };
